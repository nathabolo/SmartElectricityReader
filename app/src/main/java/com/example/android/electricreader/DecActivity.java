...
public class DecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Find the id of add comments textview

        TextView txtComments = (TextView)findViewById(R.id.add_comments);
        txtComments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent addCommnetsIntent = new Intent(DecActivity.this, AddComments.class);
                startActivity(addCommnetsIntent);
            }
        });
    ...
    private void logout() {
        ...
        Intent intent = new Intent(DecActivity.this, LoginActivity.class);
