...
/**
 * Created by User7 on 2017/03/08.
 */
...
public class NavDrawerListAdapter extends BaseAdapter {
    ...
    public NavDrawerListAdapter(Context context, ArrayList<NavigationDrawer> navDrawerItems){
    ...
    @Override
    public NavigationDrawer getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.activity_fragment_holder, null);
        }
        ...
        NavigationDrawer navigationDrawer = navDrawerItems.get(position);
