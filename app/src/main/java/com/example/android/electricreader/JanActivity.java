...
public class JanActivity extends AppCompatActivity implements View.OnClickListener {
    //UI References/Global objects declared here
    private TextView selcetDate, addComments;
    ...
    private void findViewsById() {
        addComments = (TextView)findViewById(R.id.add_comments);
    ...
    private void logout() {
        ...
        Intent intent = new Intent(JanActivity.this, LoginActivity.class);
